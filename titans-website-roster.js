...
export class TitansWebsiteRoster extends DDDSuper(I18NMixin(LitElement)) {
    ...
    constructor() {
        ...
        this.players = [
            ...
            { name: "Max Smith", position: "Center Field", image: "./images/player-2.png"},
            { name: "John Tester", position: "Pitcher", image: "./images/player-3.png"},
            { name: "Sam Johnson", position: "Catcher", image: "./images/player-4.png"},
    ...
    static get styles() {
        return [
            ...
            h2 {
                ...
                margin-bottom: var(--ddd-spacing-6) 0 var(--ddd-spacing-4);
                color: light-dark(var(--ddd-theme-default-info), var(--ddd-theme-default-shrineLight));;
            }
            .roster-grid {
                display: flex;
